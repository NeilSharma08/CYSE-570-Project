...
./build/memory/pagefault.o: ./src/memory/pagefault.c
	i686-elf-gcc $(INCLUDES) -I./src/memory $(FLAGS) -std=gnu99 -c ./src/memory/pagefault.c -o ./build/memory/pagefault.o
